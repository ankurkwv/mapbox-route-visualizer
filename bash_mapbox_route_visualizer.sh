...
locations=(
  ...
  "Santa Cruz, CA|gray"
  "Big Sur, CA|gray"
  "San Luis Obispo, CA|gray"
  "Malibu, CA|gray"
  "Twentynine Palms, CA|gray"
  "Apache Junction, AZ|gray"
  "Flagstaff, AZ|gray"
  "Albuquerque, NM|gray"
  "Santa Fe, NM|gray"
  "Marfa, TX|gray"
  "Austin, TX|gray"
  "New Orleans, LA|gray"
  "Appalachicola, FL|gray"
  "Savannah, GA|gray"
  "Charleston, SC|gray"
  "Greenville, SC|gray"
  "Asheville, NC|gray"
  "Virginia Beach, VA|gray"
  "Charleston, WV|gray"
)
...
USERNAME="ENTER YOUR MAPBOX USERNAME"
